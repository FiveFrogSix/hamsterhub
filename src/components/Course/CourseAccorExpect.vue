...
onMounted(async () => {
    color.value = configStore.getPageColor[params.value.courseTypeName]
    addClass.value["accordion-item-active"] =  true
})
                ...
                <div class="accordion" id="accordionExample">
                    ...
                    <div class="accordion-item accordion-item-custom" :class="addClass">
                        <h2 class="accordion-header" id="headingOne">
                            <button @click="actionAboutAccordion($event)" class="accordion-button fs-18px fw-bold px-md-5 py-md-4"
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                            ...
                            <div class="accordion-body font-content p-0 px-md-5">
                                ...
                                <div class="accordion accordion-flush accordion-sub" id="accordionSample">
                                    <div class="accordion-item accordion-sub-item">
                                        <h2 class="accordion-header" id="flush-headingOne">
                                            <button class="accordion-button accordion-sub-button px-md-0" type="button"
                                        ...
                                        <div id="flush-collapseOne" class="accordion-collapse px-md-0 collapse show"
                                    ...
                                    <div class="accordion-item accordion-sub-item">
                                        ...
                                        <div id="flush-collapseTwo" class="accordion-collapse  collapse px-md-0"
                                            aria-labelledby="flush-headingOne" >
                                            <div class="accordion-body fw-normal px-md-0 pt-md-0">
                                                <ul class="ps-md-4">
                                                    <li>สามารถจำแนกข้อมูลได้ชนิดต่างๆ</li>
